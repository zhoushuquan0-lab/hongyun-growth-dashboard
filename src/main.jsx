...
function AiPage() {
  ...
  function sendMessage() {
    ...
    const reply = text.includes("风险")
      ? "当前重点风险包括：万宁销量数据未建立反馈机制、保健食品资质未完成、达人/兼职费用待结算。"
      : text.includes("公牛")
        ? "公牛牌当前累计增长投入¥106,780，小红书累计笔记61篇，近90天品牌搜索量3,109，主要卡点是聚光投流资质未完成。"
        : text.includes("济众堂")
          ? "济众堂当前重点是活络油万宁销量考核和保健食品上市路径推进。活络油累计增长投入¥17,230，保健食品资质与上市策略仍需补齐。"
